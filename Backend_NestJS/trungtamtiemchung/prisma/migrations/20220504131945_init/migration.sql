...
CREATE TABLE `phieutiem` (
    `id` INTEGER NOT NULL AUTO_INCREMENT,
    `doi_tuong` VARCHAR(191) NOT NULL,
    `id_dich_vu1` INTEGER NOT NULL DEFAULT 0,
    `id_dich_vu2` INTEGER NOT NULL DEFAULT 0,
    `id_thuoc1` INTEGER NOT NULL DEFAULT 0,
    `id_thuoc2` INTEGER NOT NULL DEFAULT 0,
    `phong_benh1` VARCHAR(191) NOT NULL DEFAULT 'null',
    `phong_benh2` VARCHAR(191) NOT NULL DEFAULT 'null',
    `ten_thuoc1` VARCHAR(191) NOT NULL DEFAULT 'null',
    `ten_thuoc2` VARCHAR(191) NOT NULL DEFAULT 'null',
