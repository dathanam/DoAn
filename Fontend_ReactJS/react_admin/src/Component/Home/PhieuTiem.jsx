...
function PhieuTiem(props) {
    ...
    async function submit() {
        if (value === 'old') {
            ...
            newKH.token = localStorage.getItem("accessToken");
            newKH.table = "khachhang";
            phieuTiem.id_thuoc1 = parseInt(phieuTiem.id_thuoc1)
            phieuTiem.id_thuoc2 = parseInt(phieuTiem.id_thuoc2)
            phieuTiem.id_dich_vu1 = parseInt(phieuTiem.id_dich_vu1)
            phieuTiem.id_dich_vu2 = parseInt(phieuTiem.id_dich_vu2)
            phieuTiem.id_trang_thai = 1;
            phieuTiem.trang_thai = "chưa thanh toán";
            phieuTiem.token = localStorage.getItem("accessToken");
            ...
            try {
                ...
                alert("phiếu tiêm đã được thêm vào hệ thống !");
